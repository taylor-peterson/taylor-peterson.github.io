...
_Acoustic tags are a key piece of equipment for the Shark Tracking group.Â_ _In order to preserve battery life, each tag must be turned off after use.Â_ _Unfortunately, this is not as simple as flipping a switch - you have to precisely position a magnet on the body of the tag.Â_ _Given that I was the only one on the team capable of hearing the tags, that job fell to me._
...
While cleaning the lab, Sean and I thought to ourselves: "What would be better than an Iver2?"Â 

Our answer: an Iver4.Â 
...
The perfectly immaculate lab after Sean and I cleaned it.Â 
